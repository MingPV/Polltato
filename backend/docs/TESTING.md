...
Edit `.env` and update with your test database credentials:
...
2. Check `.env` configuration, especially `DB_TEST_*` variables
...
1. Ensure `.env` exists in the project root (`backend/`)
