...
import (
	...
	"github.com/MingPV/Polltato/internal/user/dto"
	"github.com/MingPV/Polltato/internal/user/usecase"
	"github.com/MingPV/Polltato/pkg/apperror"
	"github.com/MingPV/Polltato/pkg/middleware"
	"github.com/MingPV/Polltato/pkg/responses"
...
func (h *HttpUserHandler) setAccessTokenCookie(c *fiber.Ctx, token string) {
...
func (h *HttpUserHandler) clearAccessTokenCookie(c *fiber.Ctx) {
	secure := os.Getenv("APP_ENV") == "production"
	c.Cookie(&fiber.Cookie{
		Name:     middleware.AccessTokenCookie,
		Value:    "",
